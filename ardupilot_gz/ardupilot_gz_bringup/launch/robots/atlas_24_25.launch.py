...
def generate_launch_description():
    """Generate a launch description for the Prometheus."""
    ...
    sitl_dds = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "defaults": os.path.join(
                ...
                "config",
                "gazebo-atlas-24-25-gimbal.parm",
            )
            + ","
            + os.path.join(
                pkg_ardupilot_sitl,
            ...
            "master": "tcp:127.0.0.1:5760",
            "sitl": "127.0.0.1:5501",
            "out": "172.27.32.1:14550",
            "additional_args": "--out=udp:127.0.0.1:14550" "--out=udp:10.255.255.254:14550",
        }.items(),
    )
    ...
    sdf_file = os.path.join(
        pkg_ardupilot_gazebo, "models", "atlas_24_25", "model.sdf"
    )
        ...
        parameters=[
            {
                "config_file": os.path.join(
                    pkg_project_bringup, "config", "atlas_24_25_bridge.yaml"
                ),

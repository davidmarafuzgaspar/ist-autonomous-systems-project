    ...
    *,
    ...
    for row in range(rows):
        for col in range(cols):
            ...
            is_obs = show_obstacles and val == OBSTACLE
...
class RealRuntimeViewer:
    def __init__(self, sim: RealRuntimeSim) -> None:
        ...
        self.known_map_label = _label(
            right, "Known map — empty until Train; then π + obstacles", muted=True,
        )
        self.known_map_label.pack(anchor="w")
    ...
    def _redraw(self) -> None:
        ...
        _draw_grid(
            ...
            robot=None,
            trail=[],
            policy_fn=self._policy_fn if trained else None,
            policy_heading=ph,
            path_cells=set(),
